...
```
# 1. Using `dataset3.csv`, estimate a new predictor using the random forests algorithm. a. How does the mean squared error estimate for your random forests predictor compare with the regularized regression estimates? 
